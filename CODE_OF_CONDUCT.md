...
> **Owner configuration required:** Before accepting public contributions, the repository owner must replace this notice with a verified private conduct-reporting method. No conduct-reporting email or private channel is currently asserted by this document. Do not publish sensitive personal information in a GitHub issue.
...
This Code of Conduct is adapted from the [Contributor Covenant, version 2.1](https://www.contributor-covenant.org/version/2/1/code_of_conduct.html), available under the [Creative Commons Attribution 4.0 International licence](https://creativecommons.org/licenses/by/4.0/).
